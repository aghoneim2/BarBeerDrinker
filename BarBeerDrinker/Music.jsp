...
<title>Music Performances</title> 
</head>
<body>
	<%
		...
		out.println("<br>"); 
			...
			String query = "SELECT DISTINCT o.*, p.beer, p.day FROM price p, (SELECT bars, address, city, state, artist, music_genre FROM music INNER JOIN bars ON bars.barID=music.barID WHERE state = '" + state + "' ORDER BY city) as o WHERE p.beer = '" + beer + "' AND p.day = '" + day + "' LIMIT " + limit + ";";
			...
			while(result.next())
			{
				...
				out.print("<td>");
				out.print("<center>");
				out.print(result.getString("artist")); 
				out.print("</center>");
				out.print("</td>");
				
				out.print("<td>");
				out.print("<center>");
				out.print(result.getString("music_genre")); 
				out.print("</center>");
				out.print("</td>");
				out.print("</tr>");
			}
